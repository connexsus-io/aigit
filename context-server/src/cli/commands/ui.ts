...
// 🛡️ Sentinel: Fix timing attack vulnerability
// Hashing the tokens before comparison prevents timing attacks that could otherwise leak the length or contents of the token.
