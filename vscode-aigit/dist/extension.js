...
function activate(context) {
    ...
    context.subscriptions.push(vscode.commands.registerCommand('aigit.init', () => {
        const terminal = getOrCreateTerminal();
        terminal.sendText('aigit init');
        terminal.show();
    }));
    context.subscriptions.push(vscode.commands.registerCommand('aigit.commitTask', async () => {
    ...
    context.subscriptions.push(vscode.commands.registerCommand('aigit.handoff', async () => {
        const result = await vscode.window.showInputBox({
    ...
    context.subscriptions.push(vscode.commands.registerCommand('aigit.syncSkills', () => {
        const terminal = getOrCreateTerminal();
