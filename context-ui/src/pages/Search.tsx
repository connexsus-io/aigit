        ...
        <form aria-label="Semantic Context Search" onSubmit={handleSearch} className="w-full flex gap-3 mt-4" style={{ width: '100%', display: 'flex', gap: '1rem', marginTop: '1rem' }}>
          <div className="relative" style={{ flex: 1, position: 'relative' }}>
            ...
            <input 
              ...
              className="w-full bg-black/20 border border-white/10 rounded-lg py-3 pl-12 pr-20 text-white focus:outline-none focus:border-brand-primary"
              style={{ width: '100%', padding: '0.75rem 5rem 0.75rem 3rem', background: 'rgba(0,0,0,0.2)', border: '1px solid var(--border-dim)', borderRadius: '8px', color: '#fff', fontSize: '1rem' }}
            />
            {query.length === 0 ? (
              <div
              ...
              <div
                className="absolute right-3 top-1/2 -translate-y-1/2 flex items-center gap-1 text-muted"
                style={{ position: 'absolute', right: '1rem', top: '50%', transform: 'translateY(-50%)', display: 'flex', alignItems: 'center', gap: '0.25rem' }}
              >
                <kbd aria-hidden="true" style={{ fontSize: '0.7rem', fontFamily: 'monospace', opacity: 0.7, border: '1px solid var(--border-dim)', borderRadius: '4px', padding: '0.125rem 0.25rem', backgroundColor: 'var(--bg-surface)', pointerEvents: 'none' }}>Esc</kbd>
                <button
                  type="button"
                  ...
                  className="text-muted hover:text-white focus-visible:ring-2"
                  style={{ color: 'inherit', background: 'transparent', border: 'none', cursor: 'pointer', padding: '0.25rem', display: 'flex', alignItems: 'center' }}
                >
                  <X size={16} />
                </button>
              </div>
