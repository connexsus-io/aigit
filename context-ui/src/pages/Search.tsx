        ...
        <form aria-label="Semantic Context Search" onSubmit={handleSearch} className="w-full flex gap-3 mt-4" style={{ width: '100%', display: 'flex', gap: '1rem', marginTop: '1rem' }}>
          <div className="relative" style={{ flex: 1, position: 'relative' }}>
            ...
            {query.length === 0 ? (
              ...
              <div className="absolute right-3 top-1/2 -translate-y-1/2 flex items-center gap-2" style={{ position: 'absolute', right: '1rem', top: '50%', transform: 'translateY(-50%)' }}>
                <kbd aria-hidden="true" style={{ fontSize: '0.75rem', fontFamily: 'monospace', opacity: 0.5 }}>Esc</kbd>
                <button
                  type="button"
                  ...
                  style={{ color: 'var(--text-muted)', background: 'transparent', border: 'none', cursor: 'pointer', padding: '0.25rem' }}
                >
                  <X size={16} />
                </button>
              </div>
