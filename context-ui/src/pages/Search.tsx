        ...
        <form aria-label="Semantic Context Search" onSubmit={handleSearch} className="w-full flex gap-3 mt-4" style={{ width: '100%', display: 'flex', gap: '1rem', marginTop: '1rem' }}>
          <div className="relative" style={{ flex: 1, position: 'relative' }}>
            ...
            <input 
              ...
              style={{ width: '100%', padding: '0.75rem 4rem 0.75rem 3rem', background: 'rgba(0,0,0,0.2)', border: '1px solid var(--border-dim)', borderRadius: '8px', color: '#fff', fontSize: '1rem' }}
            />
            {query.length === 0 ? (
              <div
              ...
              >
                <X size={16} />
                <kbd aria-hidden="true" style={{ fontSize: '0.7rem', fontFamily: 'monospace', opacity: 0.7 }}>Esc</kbd>
              </button>
            )}
          </div>
          <button
