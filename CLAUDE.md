...
If you are starting a new task, you must use `.agent/templates/task-template.md` to create a new `.aigit/tasks/{task-slug}.md` file to maintain the task handoff API.
